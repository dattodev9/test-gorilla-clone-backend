...
export class UpdateUserDB1744108849675 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "test" ADD "duration" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "test" ADD "question_count" integer NOT NULL DEFAULT '0'`);
    }
